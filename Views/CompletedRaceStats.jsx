        ...
        return (
            <>
                <View style={styles.container}>
                    ...
                    <Grid>
                        <Col>
                            ...
                            <Row style={styles.row}>
                                <Text style={styles.colText}>Total Time</Text>
                            </Row>
                            <Row style={styles.row}>
                                <Text style={styles.colText}>Average Pace</Text>
                            </Row>
                            <Row style={styles.row}>
                                <Text style={styles.colText}>Distance Run</Text>
                            </Row>
                            <Row style={styles.row}>
                        ...
                        <Col>
                            ...
                            <Row style={styles.row}>
                                <Text style={styles.colText}>
                                    {completedRace.totalTime}
                                </Text>
                            </Row>
                            <Row style={styles.row}>
                                <Text style={styles.colText}>
                                    {completedRace.averagePace}
                                </Text>
                            </Row>
                            <Row style={styles.row}>
                                <Text style={styles.colText}>
                                    {completedRace.distanceRan} miles
                                </Text>
                            </Row>
                            <Row style={styles.row}>
                                <Text style={styles.colText}>
                                    {completedRace.calConsume} calories
                                </Text>
                            </Row>
                            <Row style={styles.row}>
                                <Text style={styles.colText}>
                                    {completedRace.calBurned} calories
                                </Text>
                            </Row>
                        </Col>
                    </Grid>
                ...
                <View style={styles.container}>
                    ...
                    {completedRace.aidStations.map((aid) => (
                        <Pressable
                            onPress={() =>
